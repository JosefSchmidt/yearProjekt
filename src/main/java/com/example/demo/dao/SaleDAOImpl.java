...
//    }
        ...
        public void addSale(Sale sale){
            ...
            jdbcTemplate.update("INSERT into sale (employee_id, ga_low_amount, ga_med_amount, ga_high_amount, ga_super_high_amount, fl_low_amount, fl_med_amount, fl_high_amount, fl_super_high_amount, vas_amount, accessory_amount)" + "VALUES ('" + sale.getEmployee_id() + "', '" + sale.getGa_low_amount()+ "', '" + sale.getGa_med_amount() + "', '" + sale.getGa_high_amount() + "', '" + sale.getGa_super_high_amount()+ "', '" + sale.getFl_low_amount()+ "', '" + sale.getFl_med_amount()+ "', '" + sale.getFl_high_amount()+ "', '" + sale.getFl_super_high_amount()+ "', '" + sale.getVas_amount()+ "', '" + sale.getAccessory_amount() + "')");
